            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.CheckoutSettings", b =>
                {
                    ...
                    b.ToTable("CheckoutSettings", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.Components.StructuralComponentsSettings", b =>
                {
                    ...
                    b.ToTable("StructuralComponentsSettings", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.ContactNotificationSettings", b =>
                {
                    ...
                    b.Property<string>("EmailSubjectTemplate")
                        ...
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasDefaultValue("New Contact Message from {name}");
                    ...
                    b.Property<string>("ToastErrorMessage")
                        ...
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasDefaultValue("Error sending message. Please try again.");
                    ...
                    b.Property<string>("ToastSuccessMessage")
                        ...
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasDefaultValue("Message sent successfully!");
                    ...
                    b.ToTable("ContactNotificationSettings", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.CustomerSecurityQuestion", b =>
                {
                    ...
                    b.ToTable("CustomerSecurityQuestions", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.EditorHistory", b =>
                {
                    ...
                    b.ToTable("EditorHistories", (string)null);
                });

            modelBuilder.Entity("WebsiteBuilderAPI.Models.GreenApiWhatsAppConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("AutoAcknowledgeMessages")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("BlacklistedNumbers")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("RateLimitSettings")
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("GreenApiWhatsAppConfigs", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.HostReview", b =>
                {
                    ...
                    b.ToTable("HostReviews", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.PageSectionChild", b =>
                {
                    ...
                    b.ToTable("PageSectionChildren", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.ProductShoppingCart", b =>
                {
                    ...
                    b.ToTable("ProductShoppingCarts", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.ReviewInteraction", b =>
                {
                    ...
                    b.ToTable("ReviewInteractions", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.ReviewStatistics", b =>
                {
                    ...
                    b.ToTable("ReviewStatistics", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.RoomBlockPeriod", b =>
                {
                    ...
                    b.ToTable("RoomBlockPeriods", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.RoomReservationCart", b =>
                {
                    ...
                    b.ToTable("RoomReservationCarts", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.ThemeConfig.GlobalThemeConfig", b =>
                {
                    ...
                    b.ToTable("GlobalThemeConfigs", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.WhatsAppConfig", b =>
                {
                    ...
                    b.ToTable("WhatsAppConfigs", (string)null);
                });
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.WhatsAppConversation", b =>
                {
                    ...
                    b.HasIndex("UnreadCount")
                        .HasFilter("\"UnreadCount\" > 0");

                    b.HasIndex("CompanyId", "CustomerPhone", "BusinessPhone")
                        .IsUnique();
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.WhatsAppMessage", b =>
                {
                    ...
                    b.HasIndex("ReadAt")
                        .HasFilter("\"ReadAt\" IS NULL AND \"Direction\" = 'inbound'");
            ...
            modelBuilder.Entity("WebsiteBuilderAPI.Models.ContactNotificationSettings", b =>
                {
                    b.HasOne("WebsiteBuilderAPI.Models.Company", "Company")
                        .WithOne()
                        .HasForeignKey("WebsiteBuilderAPI.Models.ContactNotificationSettings", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
